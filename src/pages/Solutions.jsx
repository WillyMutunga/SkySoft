    ...
    <>
      ...
      <section className="services container" style={{ marginTop: '-4rem', position: 'relative', zIndex: 2 }}>
        <div className="services-grid">
          {/* Web Dev */}
          <div className="service-card reveal solution-card">
            <img src="/assets/images/web_dev_card.jpg" alt="Custom Web Development" className="card-img solution-img" />
            <div className="card-content solution-content">
          ...
          {/* Mobile Dev */}
          <div className="service-card reveal solution-card reverse" style={{ background: 'rgba(139, 92, 246, 0.05)', borderColor: 'rgba(139, 92, 246, 0.2)' }}>
            <img src="/assets/images/mobile_dev_card.jpg" alt="Mobile App Development" className="card-img solution-img" />
            <div className="card-content solution-content">
          ...
          {/* Networking */}
          <div className="service-card reveal solution-card" style={{ background: 'rgba(16, 185, 129, 0.05)', borderColor: 'rgba(16, 185, 129, 0.2)' }}>
            <img src="/assets/images/cloud_network_card.jpg" alt="Enterprise Networking" className="card-img solution-img" />
            <div className="card-content solution-content">
